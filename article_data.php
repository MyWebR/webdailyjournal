          ...
          <tbody>
               ...
               ?>
                    <tr>
                         ...
                         <td>
                              <a href="#" title="edit" class="bg-primary p-2 rounded" data-bs-toggle="modal" data-bs-target="#modalEdit<?= $row["id"] ?>">
                                   <i class="bi bi-pencil-square text-white fs-5"></i>
                              </a>
                              <a href="#" title="delete" class="bg-danger p-2 rounded" data-bs-toggle="modal" data-bs-target="#modalHapus<?= $row["id"] ?>">
