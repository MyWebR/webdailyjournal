        ...
        <div class="card border border-5 border-warning-subtle mb-3 shadow bg-warning rounded-4" style="max-width: 18rem;">
            <div class="card-body">
                <div class="d-flex justify-content-between">
                    <div class="p-3">
                        <h5 class="card-title"> <i class="bi bi-file-earmark-text"></i>
                            Article</h5>
                    </div>
                    <div class="p-3">
                        <span class="badge rounded-pill text-bg-warning fs-2"><?php echo $jumlah_article; ?></span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="col">
        <div class="card border border-5 border-success-subtle mb-3 shadow bg-success rounded-4" style="max-width: 18rem;">
            <div class="card-body">
                <div class="d-flex justify-content-between">
                    <div class="p-3">
                        <h5 class="card-title"> <i class="bi bi-images"></i>
                            Gallery</h5>
                    </div>
                    <div class="p-3">
                        <span class="badge rounded-pill text-bg-success text-dark fs-2"><?php echo $jumlah_gallery;
                                                                                        ?></span>
                    </div>
                </div>
            </div>
    ...
    <div class="col">
        <div class="card border border-5 border-secondary-subtle mb-3 shadow bg-secondary rounded-4" style="max-width: 18rem;">
            <div class="card-body">
                <div class="d-flex justify-content-between">
                    <div class="p-3">
                        <h5 class="card-title"> <i class="bi bi-file-earmark-richtext"></i>
                            About</h5>
                    </div>
                    <div class="p-3">
                        <span class="badge rounded-pill text-bg-secondary text-dark fs-2"><?php echo $jumlah_about;
                                                                                            ?></span>
                    </div>
                </div>
            </div>
    ...
    <div class="col">
        <div class="card border border-5 border-primary-subtle mb-3 shadow bg-primary rounded-4" style="max-width: 18rem;">
            <div class="card-body">
                <div class="d-flex justify-content-between">
                    <div class="p-3">
                        <h5 class="card-title"> <i class="bi bi-buildings"></i>
                            Cabang</h5>
                    </div>
                    <div class="p-3">
                        <span class="badge rounded-pill text-bg-primary text-dark fs-2"><?php echo $jumlah_cabang;
                                                                                        ?></span>
                    </div>
                </div>
            </div>
