          ...
          <tbody>
               ...
               ?>
                    <tr>
                         ...
                         <td class="align-middle"><strong><?= $row["judul"] ?></strong></td>
                         <td class="align-middle"><?= $row["uploaded_at"] ?></td>
                         <td class="align-middle">
                              <?php
                              if ($row["gambar"] != '') {
                                   if (file_exists('img_gallery/' . $row["gambar"])) {
                              ?>
                                        <img src="img_gallery/<?= $row["gambar"] ?>" class="rounded" width="100">
                              <?php
                                   }
                              }
                              ?>
                         ...
                         <td class="align-middle">
                              ...
                              <div class="d-flex align-items-center gap-3">
                                   ...
                                   <a href="#" title="delete" class="bg-danger p-2 rounded text-white text-decoration-none" data-bs-toggle="modal" data-bs-target="#modalHapus<?= $row["id"] ?>">
